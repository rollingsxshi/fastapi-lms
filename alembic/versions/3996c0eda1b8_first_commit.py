...
Revision ID: 3996c0eda1b8
Revises:
Create Date: 2023-04-07 00:50:26.112239
...
def upgrade() -> None:
    ...
    role_enum = postgresql.ENUM('teacher', 'student', name='role', create_type=False)
    ...
    type_enum = postgresql.ENUM('lesson', 'quiz', 'assignment', name='contenttype', create_type=False)
